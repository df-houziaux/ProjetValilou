...
namespace ProjetValilou.Data
{
    public static class DbInitializer
    {
        public static async Task Initialize(IServiceProvider serviceProvider)
        {
            ...
            // Vide la table Products avant de réinsérer des données
           ...
           new Product { Name = "Savon Vanille 1", ImageUrl = "/images/savonvanille1.jpg", Description = "Savon parfumé à la Vanille", Price = 15.99m, Ingredients = "Vanille, Cire de soja", Category = "Catégorie 2", Stock = 8 },
            ...
            new Product { Name = "Savon Rosé 2", ImageUrl = "/images/savonrosée2.jpg", Description = "Savon parfumé à la rose", Price = 18.99m, Ingredients = "Rosée, Cire de soja", Category = "Catégorie 3", Stock = 0},
            new Product { Name = "Savon Rosé 3", ImageUrl = "/images/savonrosée3.jpg", Description = "Savon parfumé à la rose", Price = 19.99m, Ingredients = "Rosée, Cire de soja", Category = "Catégorie 3", Stock = 3},
            new Product { Name = "savon Rosé 4", ImageUrl = "/images/savonrosée4.jpg", Description = "savon parfumée à la rose ", Price = 20.99m, Ingredients = "Rosée, Cire de soja" ,Category="Catégorie 3", Stock = 5},
            new Product { Name = "savon Rosé 5", ImageUrl = "/images/savonrosée5.jpg", Description = "savon parfumée à la rose ", Price = 21.99m, Ingredients = "Rosée, Cire de soja" ,Category="Catégorie 3", Stock = 5},
            ...
            Console.WriteLine("Insertion des données en cours...");

            // Ajoute les produits à la base de données
